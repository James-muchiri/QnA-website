...
<div class="content mt-3">
  ...
  <div class="col-sm-12">
    <form id="regForm" action="/update_question" method="POST" enctype="multipart/form-data">
        @csrf <!-- {{ csrf_field() }} -->
                   <div class="tab">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Question Description:</label> <br>
                    <input type="text" class="form-control"  name="id" value="{!! $question->id!!}" hidden>        
                    <input type="text" class="form-control"  name="description" value="{!! $question->description !!}" required>
                  </div>
                 <div class="form-group" >
                      <div>
                        <label for="exampleInputEmail1" class="form-label">Questions here:</label>
                    
                          <textarea id="txtarea" name="question">
                            <?php     echo htmlspecialchars($question->html);
                            ?>
                          </textarea>
                 ...
                 <div id="{{$question_file->id}}">
                  <p>Question Image</p>
                      <a type="button" class="btn btn-danger"  onclick="removeimage({{$question_file->id}})" style="font-size:14px; float: right; background-color:rgb(145, 24, 24);" >Remove <i class="fa fa-close"></i></a>
<br><br>
                      <br>
                      ...
                      <div id="{{$question_file->id}}">
                        <p>Question Pdf</p>
                        <a type="button" class="btn btn-danger"  onclick="removeimage({{$question_file->id}})" style="font-size:14px; float: right; background-color:rgb(145, 24, 24);" >Remove <i class="fa fa-close"></i></a>
                        <br>       <iframe src="{{ asset('product') }}/{{$question_file->file}}#toolbar=0" width="100%" height="250px">
                          </iframe>
            ...
            <div class="tab">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="recipient-name" value="{!! $des->preview !!}" name="preview" required>
                  </div>
                    ...
                    <div class="form-group" >
                      <div>
                          <textarea id="txtarea2" name="answer">
                            <?php     echo htmlspecialchars($des->html);
                            ?>
                          </textarea>
             ...
             <div id="{{1000+$answer_file->id}}">
              <p>Question Image</p>
                  <a type="button" class="btn btn-danger"  onclick="removeanswer({{$answer_file->id}})" style="font-size:14px; float: right; background-color:rgb(145, 24, 24);" >Remove <i class="fa fa-close"></i></a>
<br><br>
                  <br>
                  ...
                  <div id="{{1000+$answer_file->id}}">
                    <p>Question Pdf</p>
                    <a type="button" class="btn btn-danger"  onclick="removeanswer({{$answer_file->id}})" style="font-size:14px; float: right; background-color:rgb(145, 24, 24);" >Remove <i class="fa fa-close"></i></a>
                    <br>       <iframe src="{{ asset('product') }}/{{$answer_file->file}}#toolbar=0" width="100%" height="250px">
                      </iframe>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="recipient-name" name="price" value="{!! $des->price !!}" required>
                  </div>
                  <div class="form-group">
